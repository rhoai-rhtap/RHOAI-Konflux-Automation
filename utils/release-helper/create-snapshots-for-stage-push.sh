...
echo "RBC_RELEASE_BRANCH_COMMIT=${RBC_RELEASE_BRANCH_COMMIT}"
  ...
  do
    ...
    fbc_release_yaml_path=${release_artifacts_dir}/release-fbc-stage-ocp-${fbc_application_suffix}-${component_application}-${epoch}.yaml
    ...
    then
      fbc_addon_release_yaml_path=${release_artifacts_dir}/release-fbc-addon-stage-ocp-${fbc_application_suffix}-${component_application}-${epoch}.yaml
    ...
    fbc_snapshot_yaml_path=${release_artifacts_dir}/snapshot-fbc-stage-ocp-${fbc_application_suffix}-${component_application}-${epoch}.yaml
